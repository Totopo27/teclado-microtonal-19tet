...
const keyConfigurations = [
  ...
  { id: '0b', name: 'do', value: 43, top: 750, left: 50, color: 'white', text: '0' },
  { id: '1b', name: 'do#', value: 44, top: 795, left: 128, color: 'dark-gray', text: '1' },
  { id: '2b', name: 'reb', value: 45, top: 705, left: 128, color: 'dark-gray', text: '2' },
  { id: '3b', name: 're', value: 46, top: 750, left: 206, color: 'white', text: '3' },
  { id: '4b', name: 're#', value: 47, top: 795, left: 284, color: 'dark-gray', text: '4' },
  { id: '5b', name: 'mib', value: 48, top: 705, left: 284, color: 'dark-gray', text: '5' },
  { id: '6b', name: 'mi', value: 49, top: 750, left: 362, color: 'white', text: '6' },
  { id: '7b', name: 'mi#', value: 50, top: 660, left: 362, color: 'blue', text: '7' },
  { id: '8b', name: 'fa', value: 51, top: 705, left: 439, color: 'white', text: '8' },
  { id: '9b', name: 'fa#', value: 52, top: 750, left: 514, color: 'dark-gray', text: '9' },
  { id: '10b', name: 'solb', value: 53, top: 660, left: 514, color: 'dark-gray', text: '10' },
  { id: '11b', name: 'sol', value: 54, top: 705, left: 592, color: 'white', text: '11' },
  { id: '12b', name: 'sol#', value: 55, top: 750, left: 663, color: 'dark-gray', text: '12' },
  { id: '13b', name: 'lab', value: 56, top: 660, left: 663, color: 'dark-gray', text: '13' },
  { id: '14b', name: 'la', value: 57, top: 705, left: 740, color: 'white', text: '14' },
  { id: '15b', name: 'la#', value: 58, top: 750, left: 814, color: 'dark-gray', text: '15' },
  { id: '16b', name: 'sib', value: 59, top: 660, left: 814, color: 'dark-gray', text: '16' },
  { id: '17b', name: 'si', value: 60, top: 705, left: 892, color: 'white', text: '17' },
  { id: '18b', name: 'si#', value: 61, top: 615, left: 892, color: 'blue', text: '18' },
